      ...
      <main className="pt-24">
        <section className="section-padding bg-gradient-luxury relative">
          ...
          <div className="container mx-auto container-padding relative text-center">
            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">{t.pages.about.hero}</h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">{t.pages.about.heroSubtitle}</p>
          </div>
        </section>
        <WhyUsSection />
      </main>
