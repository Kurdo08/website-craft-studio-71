        ...
        <section className="py-20 relative overflow-hidden">
          ...
          <div className="container mx-auto container-padding relative">
            <div className="max-w-2xl">
              <h1 className="font-display text-4xl md:text-5xl font-bold text-foreground mb-4">{t.pages.quote.hero}</h1>
              <p className="text-lg text-muted-foreground">{t.pages.quote.heroSubtitle}</p>
            </div>
          </div>
        </section>
